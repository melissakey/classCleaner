...
int sample_Fik(int N, int i, const Rcpp::IntegerVector& k_indices, const Rcpp::IntegerVector::iterator& sim_vector_start, const Rcpp::IntegerVector::iterator& sim_vector_end);
